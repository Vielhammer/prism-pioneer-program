...
fun main(args: Array<String>) {
    ...
    val batchId = try { CredentialBatchId.fromString(args[2])!! } catch (e: Exception) {throw Exception("expected batch id as third argument")}
    val credentialHash = try { Sha256Digest.fromHex(args[3]) } catch (e: Exception) {throw Exception("expected credential hash as fourth argument")}
